...
window.globalVariable = {
    ...
    message: {
        errorMessage: "Error Occurred, Please contact Administrator." //Default error message.
    },
    oAuth: {
    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        $stateProvider
            ...
            .state('app.newloan', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/newloan-list.html",
             ...
             .state('app.createloan', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/newloan.html",
                        controller: 'newloanDetailCtrl'
                    }

                }
            })
             .state('app.newloandetail', {
                url: "/newloandetail",
                 params: {
                    newloandetail: null,
                    actionDelete: false
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/newloan-detail.html",
                        controller: 'newloanDetailCtrl'
                    }
             ...
             .state('app.repayment', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/repayment.html",
                        controller: 'loanPaymentCtrl'
                    }

                }
            })
             .state('app.preclosureloan', {
                url: "/preclosureloan",
                params:{
                    isAnimated:false,
                    actionDelete: false
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/preclosureloan-list.html",
                        controller: 'preclosureloanCtrl'
                    }

                }
            })
           
             .state('app.emischedule', {
                url: "/emischedule",
                params:{
                    isAnimated:false
                },
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/emischedule-list.html",
                        controller: 'emischeduleCtrl'
                    }
            ...
            .state('app.emitable', {
                url: "/emitable",
                 params: {
                    emischeduledetail: null,
                    actionDelete: false
                },
                cache: false,
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/emitable.html",
                        controller: 'preclosureloanCtrl'
                    }
             ...
             .state('app.borrowers', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/borrowers-list.html",
                        controller: 'borrowersCtrl'
                    }

                }
            })
             .state('app.borrowersdetail', {
                url: "/borrowersdetail",
                 params: {
                    borrowerdetail: null,
                    actionDelete: false
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/borrowers-detail.html",
                        controller: 'borrowersDetailCtrl'
                    }
            ...
            .state('app.expense', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/expense-list.html",
             ...
             .state('app.expensedetail', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/expense-detail.html",
             ...
             .state('app.password', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/emi/html/password.html",
